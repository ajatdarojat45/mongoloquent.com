...
<Tabs>
	<TabItem value="Typescript" label="Typescript" default>
    ```typescript
    collect<number>([1,2,3,4,5]).after("4", true);
...
<Tabs>
	<TabItem value="Typescript" label="Typescript" default>
    ```typescript
    collect<number>([2, 4, 6, 8]).after(function (item) {
      return item > 5;
    });
...
<Tabs>
	<TabItem value="Typescript" label="Typescript" default>
    ```typescript
    const collection = collect<IData>([{name: "Ajat", framework: "Mongoloquent"}]);

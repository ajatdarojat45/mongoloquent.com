...
<Tabs>
    ...
    export class UsersController {
      constructor(
        @InjectModel() private userModel: typeof User,
      ...
      async createMany(
        ...
        await this.profilesService.createDefaultProfile();
...
<Tabs>
    ...
    export class ProfilesService {
      constructor(
        @InjectDB() private db: DB,
        @InjectModel() private profileModel: typeof Profile
      ) {}

      async createDefaultProfile() {
        const session = this.db.getSession()

        await this.profileModel.insert(
          { bio: 'This is a default bio', avatarUrl: null },
          { session },
        )
      }
    }

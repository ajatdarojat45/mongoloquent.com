...
The query also provides an `insert` method that may be used to insert records into the database collection. The `insert` method accepts an object of column names and values:
